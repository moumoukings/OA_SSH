...
public class Pager<T> {
	 ...
	 *            本页包含的数据
	 */
	public Pager(int currentPage, int totalSize, int pageSize, List<T> data) {
	...
	public String toString() {
		return "Pager [currentPage=" + currentPage + ", pageSize=" + pageSize + ", total=" + total + ", pageCount="
				+ pageCount + ", startRecord=" + startRecord + ", hasPreviousPage=" + hasPreviousPage + ", hasNextPage="
				+ hasNextPage + ", onlyOnePage=" + onlyOnePage + ", pageRecords' sizes is:" + pageRecords.size() + "]";
	}

	public boolean copy (@SuppressWarnings("rawtypes") Pager pager){
		if (pager == null)
			return false;
